...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument('--data_dir', type=str,
                        ...
                        help='Root data dir containing eval/test.json and eval/images/')
    parser.add_argument('--images_grid_dir', type=str, default='eval/images',
                        help='Sub-dir under data_dir that holds the PNG images')
...
def build_eval_image_index(data_dir: str, train_json: str, images_grid_dir: str):
    ...
    Fallback uses eval/images naming: eval_{j:03d}_n{num_nodes}.png
    """
    ...
    for j, rec in enumerate(eval_data):
        # Always use eval/images naming: eval_{j:03d}_n{num_nodes}.png
...
def evaluate_vision(args, model, processor, eval_rows, number_dataset):
    ...
    save_path = os.path.join(os.path.dirname(args.model_id) or '.', 'eval_predictions_image.json')
    records = []
